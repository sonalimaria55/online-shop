...
//         console.log("RAW productVariants:", req.body.productVariants);
...
//             console.log(
//                 "FILTERED productVariants:",
//                 JSON.stringify(productVariants, null, 2)
//             );


//             console.log("FILTERED productVariants", productVariants);
//         }
...
//         console.log(
//             "FINAL productVariants BEFORE SAVE:",
//             JSON.stringify(productVariants, null, 2)
//         );
...
exports.getHomeCollections = async (req, res) => {
    try {
        ...
        console.error("GET HOME COLLECTIONS ERROR");
        console.error(error);
